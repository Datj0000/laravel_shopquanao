<div class="card card-custom">
    <div class="card-header flex-wrap py-5">
        <div class="card-title">
            <h3 class="card-label">Danh sách bình luận sản phẩm
                    ...
                    <form class="form">
                        ...
                        <div class="card-body">
                            ...
                            <div class="form-group">
                                ...
                                <span class="form-text text-muted">Vui lòng trả lời bình luận sản phẩm</span>
                            </div>
                        </div>
...
<script type="text/javascript">
    $(document).ready(function() {
        ...
        $(document).on('click', '#reply_comment', function(e) {
            var comment_product_id = $('#product_id').val();
        ...
        $(document).on('click', '.edit', function(e) {
            ...
            $.ajax({
                url: 'view-reply-comment/' + comment_id,
                method: 'GET',
                success: function(response) {
                    $('#comment_id').val(response.data.comment_id);
                    $('#product_id').val(response.data.comment_product_id);
                }
            })
        });
